...
import { Auth, createUserWithEmailAndPassword, getAuth, onAuthStateChanged, sendEmailVerification, sendPasswordResetEmail, signInWithEmailAndPassword } from '@angular/fire/auth';
  ...
  async register(formValue: any) {
    try {
      ...
      const data = {
        ...
        emailVerified: false, // Set initial email verification status to false
      };
